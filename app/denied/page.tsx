        ...
        <div className="w-screen h-screen flex [&&&]:pl-0  pl-[70px] xl:pl-[260px]">
            <div className="w-1/2  h-full flex flex-col items-center justify-center gap-5">
                ...
                <div className=" flex gap-8  ">
                    <Link href="../../login/" className='bg-orange-900 p-3 text-gray-200 rounded-sm '>Go Back</Link>
                    <Link href="../../signin/" className='bg-slate-900 p-3 text-gray-200 rounded-sm'>Go to Sign In page</Link>
