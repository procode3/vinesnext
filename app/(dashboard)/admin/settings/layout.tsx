  ...
  return (
    <div className='bg-white w-screen h-full flex flex-col gap-4 px-4'>
      ...
      <div className="main-container flex flex-col sm:flex-row shadow-sm">
        <div className="settings-nav flex sm:flex-col items-center sm:justify-start shadow-sm w-full sm:w-48 p-4   opacity-[100%]">
          ...
          <div  className="text-white bg-red-600 text-xs md:text-[12px]   hover:bg-red-400 hover:text-white cursor-pointer transition ease-in-out duration-400 rounded"> <Dialog>
