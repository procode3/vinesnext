      ...
      {appRoutes.map((route, idx) =>
        route.sidebarProps.child ? (
          <div key={idx} className=''>
            <div className="flex flex-row justify-between items-center  my-1 rounded text-black hover:bg-orange-600 hover:text-white">
            <Link key={route.path} href={route.path!} className={`flex flex-col md:flex-row  gap-x-2 px-4 py-2 text-[12px]  transition ease-in-out duration-400 gap-[10px]`}>
