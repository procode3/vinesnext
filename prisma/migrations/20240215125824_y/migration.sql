-- CreateEnum
CREATE TYPE "Citation_style" AS ENUM ('MLA', 'APA6', 'APA7', 'CHICAGO', 'HARVARD', 'TURABIAN', 'VANCOUVER', 'OSCOLA', 'IEEE', 'AMA', 'ACS', 'AGLC', 'ASA', 'CSE', 'OTHER');

-- CreateEnum
CREATE TYPE "Education_level" AS ENUM ('HIGH_SCHOOL', 'UNDERGRADUATE', 'COLLEGE', 'MASTERS', 'PHD', 'OTHER');

-- CreateEnum
CREATE TYPE "FileType" AS ENUM ('INSTRUCTIONS', 'RUBRIC', 'ORDER_DOCUMENT', 'REVISION_DOCUMENT', 'GRAMMARLY_REPORT', 'TURNITIN_REPORT', 'OTHER');
...
-- CreateEnum
CREATE TYPE "Spacing" AS ENUM ('SINGLE', 'DOUBLE', 'ONEANDHALF');
...
-- AddForeignKey
ALTER TABLE "Rating" ADD CONSTRAINT "Rating_settingsId_fkey" FOREIGN KEY ("settingsId") REFERENCES "Settings"("id") ON DELETE SET NULL ON UPDATE CASCADE;
